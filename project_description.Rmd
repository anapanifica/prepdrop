...
\begin{center}
Final project on linguistic data analysis (version 2, 14.06.20) \\
...
Now let me load and prepare these datasets for further analysis (you can surely skip section 2.1, if your are not intersted in these rather technical things).
...
This is the end of the statistical part of the research. In the paper we disuss the obtained results also in light of some cross-linguistic considerations.
